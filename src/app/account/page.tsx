                ...
                <AnimatePresence>
                    {isScanning && (
                        ...
                        >
                            ...
                            {scanResult === "success" ? (
                                <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} className="text-center space-y-8 animate-in zoom-in duration-500">
                                    <div className="w-40 h-40 rounded-full border-[10px] border-gold flex items-center justify-center mx-auto shadow-[0_0_80px_rgba(255,184,0,0.4)]">
                                ...
                                <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} className="text-center space-y-8">
                                    <div className="w-40 h-40 rounded-full border-[10px] border-red-500 flex items-center justify-center mx-auto shadow-[0_0_80px_rgba(239,68,68,0.4)]">
                                ...
                                <div className="max-w-md w-full space-y-12">
                                    ...
                                    <div className="relative aspect-square w-full border border-white/10 rounded-3xl overflow-hidden bg-white/[0.02]">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex items-center gap-4 text-white/20">
                                            ...
                                            <span className="text-[10px] font-bold uppercase tracking-widest whitespace-nowrap">Simulator Controls</span>
                                            <div className="h-[1px] flex-grow bg-white/10" />
                                        </div>
                                        <div className="grid grid-cols-2 gap-4">
                                            <button onClick={() => setScanResult("success")} className="bg-gold text-black p-5 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:scale-105 transition-all">Mock Success</button>
                                            <button onClick={() => setScanResult("error")} className="border border-white/10 p-5 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-red-500/10 hover:border-red-500 transition-all text-red-500">Mock Error</button>
                                        </div>
                                        <div className="relative">
                                            <input
                                                type="text"
                                                placeholder="MANUAL CODE INPUT..."
                                                value={manualCode}
                                                onChange={(e) => setManualCode(e.target.value)}
                                                className="w-full bg-black border border-white/10 p-5 rounded-xl text-[10px] font-bold uppercase tracking-[0.3em] outline-none focus:border-gold transition-all"
                                            />
                                            <button onClick={() => setScanResult("success")} className="absolute right-4 top-1/2 -translate-y-1/2 text-gold hover:scale-110 transition-transform">
                                                <ArrowRight size={20} />
                                            </button>
                                        </div>
                                    </div>
